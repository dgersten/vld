...
CMFCExampleDlg::CMFCExampleDlg (CWnd * pParent /* =NULL */):
    CDialog(CMFCExampleDlg::IDD, pParent)
{
    // {{AFX_DATA_INIT(CMFCExampleDlg)
...
void CMFCExampleDlg::DoDataExchange (CDataExchange * pDX)
{
    ...
    // {{AFX_DATA_MAP(CMFCExampleDlg)

    DDX_Check (pDX, IDC_CHECK_LEAK, m_bLeak);
...
/////////////////////////////////////////////////////////////////////////////
// CMFCExampleDlg message handlers
