...
extern "C"
{
    ...
    __declspec (dllexport)
    void VLDRefreshModules ()
    {
        g_vld.RefreshModules ();
    }

    __declspec (dllexport)
    void VLDEnableModule (HMODULE module)
    {
        g_vld.EnableModule (module);
    }

    __declspec (dllexport)
    void VLDDisableModule (HMODULE module)
    {
    ...
    __declspec (dllexport)
    void VLDGetReportFilename (WCHAR * filename)
    {
    ...
    __declspec (dllexport)
    int VLDSetReportHook (int mode, VLD_REPORT_HOOK pfnNewHook)
    {
    ...
    __declspec (dllexport)
    BOOL VLDGetModulesList (WCHAR * modules, UINT size)
    {
        return g_vld.GetModulesList (modules, size);
    }

    __declspec (dllexport)
    void VLDSetReportOptions (UINT option_mask, CONST WCHAR * filename)
    {
